...
- generated at: `2026-04-17T23:43:33.550Z`
- weak signals: 1
- live misses: 0
- replay misses: 0
- recommended next signal: `n/a`

## Weak Active Signals

- `clone_propagation_drift`: improve_fix_guidance (session clean=0.5, trial miss=0, expected missing=0, present not top=0, crowded others=0, unexpected top=0, telemetry incomplete=0, remediation=n/a)

## Active Signal Misses
