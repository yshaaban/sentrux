    ...
    fn action(kind: &str, source: IssueSource, complete: bool, blocking: bool) -> AgentAction {
        AgentAction {
            ...
            repair_packet: RepairPacket {
                ...
                why_it_matters: "risk".to_string(),
                concrete_evidence: Vec::new(),
                ...
                confidence_reason: "Test repair packet.".to_string(),
                lane_reason: "Test action has a repair surface.".to_string(),
